...
///
class XccBrnExpandableText extends StatefulWidget {
  ///显示的文本
  final String text;
  ...
  /// 更多 默认白色
  final TextStyle? flodStyle;

  const XccBrnExpandableText(
      {Key? key,
      required this.text,
  ...
  _XccBrnExpandableTextState createState() => _XccBrnExpandableTextState();
}

class _XccBrnExpandableTextState extends State<XccBrnExpandableText> {
